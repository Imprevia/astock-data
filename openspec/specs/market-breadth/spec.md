...
`market-breadth` provides structured market-level breadth data for low-frequency review workflows. It exposes default index snapshots, limit-up/limit-down statistics, and stateless board-ladder derivation without requiring a stock symbol.
